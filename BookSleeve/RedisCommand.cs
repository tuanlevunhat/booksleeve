...
namespace BookSleeve
{
    ...
    enum RedisLiteral
    {
        ...
        [DbFree] FLUSHALL,
        FLUSHDB, GETBIT, GETRANGE, GETSET, HDEL, HEXISTS, HGET, HGETALL, HINCRBY, HINCRBYFLOAT, HKEYS, HLEN, HMGET, HMSET, HSCAN, HSET, HSETNX, HVALS, INCR, INCRBY, INCRBYFLOAT,
        [DbFree] INFO,
        KEYS,
        [DbFree] LASTSAVE,
        LINDEX, LINSERT, LLEN, LPOP, LPUSH, LPUSHX, LRANGE, LREM, LSET, LTRIM, MATCH, MGET,
        [DbFree] MONITOR,
        MOVE, MSET, MSETNX,
        [DbFree] MULTI,
        PERSIST,
        ...
        [DbFree] SLAVEOF,
        [DbFree] SLOWLOG,
        SMEMBERS, SMOVE, SORT, SPOP, SRANDMEMBER, SREM, SSCAN, STRLEN,
        [DbFree] SUBSCRIBE,
        ...
        [DbFree] UNWATCH,
        DUMP, RESET, RESTORE,
        WATCH, ZADD, ZCARD, ZCOUNT, ZINCRBY, ZINTERSTORE, ZRANGE, ZRANGEBYSCORE, ZRANK, ZREM, ZREMRANGEBYRANK, ZREMRANGEBYSCORE, ZREVRANGE, ZREVRANGEBYSCORE, ZREVRANK, ZSCAN, ZSCORE, ZUNIONSTORE,
        // other
