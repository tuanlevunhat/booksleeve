...
//    {
//        public static Message SortedSetRange(int db, string key, long start, long stop, bool includeScores)
//        {
//            return new RangeMessage(db, zrange, key, start, stop, includeScores);
//        }
//        public static Message SortedSetRangeDescending(int db, string key, long start, long stop, bool includeScores)
//        {
//            return new RangeMessage(db, zrevrange, key, start, stop, includeScores);
//        }
//        public static Message RemoveFromSortedSetByScore(int db, string key, long start, long stop)
//        {
//            return new RangeMessage(db, zremrangebyscore, key, start, stop, false);
//        }
//        public static Message ListRange(int db, string key, long start, long stop)
//        {
//            return new RangeMessage(db, lrange, key, start, stop, false);
//        }
//        private RangeMessage(int db, byte[] command, string key, long start, long stop, bool includeScores)
//            : base(db, command)
//        {
//            this.key = key;
//            this.start = start;
...
//        private readonly string key;
//        private readonly long start, stop;
//        private static readonly byte[]
