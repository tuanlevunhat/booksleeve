...
namespace BookSleeve
{
    ...
    /// </summary>
    /// <see cref="http://redis.io/commands#generic"/>
    public interface IKeyCommands
    {
        ...
        /// <see cref="http://redis.io/commands/del"/>
        ...
        /// <see cref="http://redis.io/commands/exists"/>
        ...
        /// <see cref="http://redis.io/commands/expire"/>
        ...
        /// <see cref="http://redis.io/commands/persist"/>
        ...
        /// <see cref="http://redis.io/commands/keys"/>
        ...
        /// <see cref="http://redis.io/commands/move"/>
        ...
        /// <see cref="http://redis.io/commands/randomkey"/>
        ...
        /// </summary>
        /// <see cref="http://redis.io/commands/rename"/>
        ...
        /// <see cref="http://redis.io/commands/renamenx"/>
        ...
        /// <see cref="http://redis.io/commands/ttl"/>
        ...
        /// <see cref="http://redis.io/commands/type"/>
    ...
    partial class RedisConnection : IKeyCommands
    {
        ...
        public Task<bool> Move(int db, string key, int targetDb, bool queueJump = false)
        {
            ...
            return ExecuteBoolean(KeyScoreMessage.Move(db, key, targetDb), queueJump);
        }
        ...
        {
            if (db < 0) throw new ArgumentOutOfRangeException("db");
            return ExecuteString(KeyMessage.Type(db, key), queueJump);
        }
    }
}
